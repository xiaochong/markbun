...
> - ✅ Windows 支持 (v0.5.0)
> - ✅ AI 聊天助手 (v0.6.0)
> - ✅ Mermaid 图表与 HTML 块 (v0.7.0)
> - ✅ Frontmatter 支持 (v0.7.0)
> - ✅ 编辑器优化与 Bug 修复 (v0.8.0)
>
...
- 📊 **Mermaid 图表** - 支持 Mermaid 图表查看，可缩放和平移
- 🌐 **HTML 块** - 支持 HTML 块渲染，带 DOMPurify 预览
- 📝 **Frontmatter** - 编辑器中显示 YAML Frontmatter
- 🌐 **国际化** - 多语言支持（英文、中文、日文、韩文等）
- 🗂️ **工作区持久化** - 文件浏览器根目录在会话间恢复
- 🪟 **智能窗口行为** - 需要时在新建窗口中打开文件和文件夹
...
### v0.7.0 ✅ 已完成
- [x] Mermaid 图表查看器，支持缩放和平移
- [x] HTML 块渲染，支持 DOMPurify 预览
- [x] Frontmatter 显示支持
- [x] 源码模式支持 undo/redo/copy/cut/select-all
- [x] AI 工具图片路径转换
- [x] 命令清单统一与国际化整合

### v0.8.0 ✅ 已完成
- [x] Mermaid 悬浮打开查看器与自适应窗口
- [x] 编辑器代码块复制/粘贴修复
- [x] HTML 块与围栏代码块识别修复
- [x] 大文件分块加载围栏代码块边界修复
- [x] 文件浏览器根目录持久化
